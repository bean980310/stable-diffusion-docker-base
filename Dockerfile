...
# Cache SD 1.5 Base Model
# RUN source /venv/bin/activate && \
#     python3 cache-sd-model.py --skip-torch-cuda-test --use-cpu=all --ckpt /sd-models/v1-5-pruned-emaonly.safetensors && \
#     deactivate

# Cache SD 1.5 Inpainting Model
# RUN source /venv/bin/activate && \
#     python3 cache-sd-model.py --skip-torch-cuda-test --use-cpu=all --ckpt /sd-models/sd-v1-5-inpainting.ckpt && \
#     deactivate

# Cache SD XL Base Model
# RUN source /venv/bin/activate && \
#     python3 cache-sd-model.py --skip-torch-cuda-test --use-cpu=all --ckpt /sd-models/sd_xl_base_1.0.safetensors && \
#     deactivate

# Cache SD XL Refiner Model
# RUN source /venv/bin/activate && \
